...
Add AWS connection info in Airflow via UI
Create Redshift serverless and connection information and store it in Airflow via UI
Run project DAG and monitor the execution via Airflow UI.
